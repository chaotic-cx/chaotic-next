            ...
            S.extend(n, {
                options: function (t) {
                    if (arguments.length > 1) {
                        ...
                        return (
                            n.remove(), f(e, n.object, n.property, { before: o, factoryArgs: [S.toArray(arguments)] })
                        );
                    }
    ...
    var U = /(\d+(\.\d+)?)px/,
        X = {
            ...
            bind: function (e, t, n, o) {
                var i = o || !1;
                return (
                    e.addEventListener ? e.addEventListener(t, n, i) : e.attachEvent && e.attachEvent("on" + t, n), X
                );
            },
        ...
        $ = (function (e) {
            function t(e, n) {
                ...
                return (
                    ...
                    S.extend(f.style, { width: "100%", height: "100%", background: "none" }),
            ...
            return S.isArray(arguments[2]) || S.isObject(arguments[2])
                ...
                : S.isNumber(n)
                  ? S.isNumber(arguments[2]) && S.isNumber(arguments[3])
                      ...
                      : S.isNumber(arguments[4])
                        ? new Q(e, t, { min: arguments[2], max: arguments[3], step: arguments[4] })
    ...
    var se = "Default",
        ...
        he = function e(t) {
            ...
            (this.domElement = document.createElement("div")),
                ...
                (this.__listening = []),
                (o = S.defaults(o, { closeOnTop: !1, autoPlace: !0, width: e.DEFAULT_WIDTH })),
