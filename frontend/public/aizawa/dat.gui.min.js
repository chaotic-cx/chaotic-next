...
!((e, t) => {
    ...
    function n(e, t, n) {
        Object.defineProperty(e, t, {
            ...
            set: function (e) {
                "RGB" !== this.__state.space && (I.recalculateRGB(this, t, n), (this.__state.space = "RGB")),
                    (this.__state[t] = e)
            },
        })
    }
    ...
    function i(e) {
        ...
        var t = e.match(U)
        return S.isNull(t) ? 0 : Number.parseFloat(t[1])
    }
    function r(e) {
        var t = e.toString()
    ...
    function h(e, t, n) {
        if (
            ...
            S.extend(n, {
                ...
                name: (e) => ((n.__li.firstElementChild.firstElementChild.innerHTML = e), n),
                listen: () => (n.__gui.listen(n), n),
                remove: () => (n.__gui.remove(n), n),
            }),
            n instanceof q)
        ) {
            ...
            S.each(["updateDisplay", "onChange", "onFinishChange", "step"], (e) => {
                var t = n[e],
                    i = o[e]
                n[e] = o[e] = () => {
            ...
            n instanceof K
                ...
                : n instanceof Z
                  ...
                  : n instanceof $ &&
                    (X.addClass(t, "color"),
                    (n.updateDisplay = S.compose(
                        (e) => ((t.style.borderLeftColor = n.__color.toString()), e),
                        n.updateDisplay,
                    )),
                    n.updateDisplay())
        n.setValue = S.compose(
            (t) => (e.getRoot().__preset_select && n.isModified() && _(e.getRoot(), !0), t),
            n.setValue,
        )
    }
    function p(e, t) {
        ...
        if (-1 !== o) {
            ...
            if (
                (void 0 === i && ((i = {}), (n.__rememberedObjectIndecesToControllers[o] = i)),
                (i[t.property] = t),
    ...
    function x(e, t) {
        var n = {}
        return (
            S.each(e.__rememberedObjects, (o, i) => {
                var r = {},
    ...
    var A = Array.prototype.forEach,
        ...
        S = {
            ...
            toArray: (e) => (e.toArray ? e.toArray() : k.call(e)),
        ...
        O = [
                    ...
                    SIX_CHAR_HEX: {
                        read: (e) => {
                            ...
                            return (
                                null !== t && {
                                    space: "HEX",
                                    hex: Number.parseInt("0x" + t[1].toString(), 0),
                                }
                            )
                        },
                        write: t,
            ...
            },
            {
                ...
                conversions: {
                    RGBA_OBJ: {
                        read: (e) =>
                            !!(S.isNumber(e.r) && S.isNumber(e.g) && S.isNumber(e.b) && S.isNumber(e.a)) && {
                                space: "RGB",
                                r: e.r,
                                g: e.g,
                                b: e.b,
                    ...
                    HSVA_OBJ: {
                        read: (e) =>
                            !!(S.isNumber(e.h) && S.isNumber(e.s) && S.isNumber(e.v) && S.isNumber(e.a)) && {
                                space: "HSV",
                                h: e.h,
                                s: e.s,
                                v: e.v,
        ...
        L = () => {
            ...
            return (
                S.each(O, (t) => {
                    if (t.litmus(e))
                        return (
                            S.each(t.conversions, (t, n) => {
                                if (((T = t.read(e)), !1 === R && !1 !== T))
                                    return (R = T), (T.conversionName = n), (T.conversion = t), S.BREAK
                            }),
                            S.BREAK
                        )
                }),
        ...
        N = {
            ...
            hex_with_component: (e, t, n) => (n << (B = 8 * t)) | (e & ~(255 << B)),
        },
        H =
        ...
        I = (() => {
            function e() {
                if ((F(this, e), (this.__state = L.apply(this, arguments)), !1 === this.__state))
    ...
    ;(I.recalculateRGB = (e, t, n) => {
        ...
        Object.defineProperty(I.prototype, "hex", {
            get: function () {
                return (
                    "HEX" !== !this.__state.space && (this.__state.hex = N.rgb_to_hex(this.r, this.g, this.b)),
                    this.__state.hex
                )
            },
            set: function (e) {
    ...
    var U = /(\d+(\.\d+)?)px/,
        X = {
            ...
            hasClass: (e, t) => new RegExp("(?:^|\\s+)" + t + "(?:\\s+|$)").test(e.className) || !1,
            getWidth: (e) => {
                ...
                P(t, [
                    {
                        ...
                        value: function () {
                            return (
                                X.isActive(this.__input) || (this.__input.value = this.getValue()),
                                j(
                                    t.prototype.__proto__ || Object.getPrototypeOf(t.prototype),
                                    "updateDisplay",
                                    this,
                ...
                return (
                    ...
                    S.isUndefined(i.__step)
                        ? 0 === i.initialValue
                            ? (i.__impliedStep = 1)
                            : (i.__impliedStep =
                                  Math.pow(10, Math.floor(Math.log(Math.abs(i.initialValue)) / Math.LN10)) / 10)
                ...
                P(t, [
                    {
                        ...
                        value: function (e) {
                            ...
                            return (
                                ...
                                j(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "setValue", this).call(
                                    this,
                                    n,
                                )
                            )
        ...
        q = ((e) => {
            function t(e, n, o, i, r) {
                ...
                var u = V(
                        this,
                        (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n, { min: o, max: i, step: r }),
                    ),
                    _ = u
                return (
                    (u.__background = document.createElement("div")),
                    (u.__foreground = document.createElement("div")),
                    X.bind(u.__background, "mousedown", (e) => {
                        document.activeElement.blur(),
                            X.bind(window, "mousemove", s),
                            X.bind(window, "mouseup", l),
                            s(e)
                    }),
                    X.bind(u.__background, "touchstart", (e) => {
        ...
        Z = ((e) => {
            function t(e, n, o) {
                ...
                return (
                    ...
                    X.bind(i.__button, "click", (e) => (e.preventDefault(), r.fire(), !1)),
            ...
            function t(e, n) {
                ...
                ;(h.domElement = document.createElement("div")),
                    ...
                    X.bind(h.__selector, "mousedown", function () {
                        X.addClass(this, "drag").bind(window, "mouseup", () => {
                            X.removeClass(p.__selector, "drag")
                        })
                    }),
                    X.bind(h.__selector, "touchstart", function () {
                        X.addClass(this, "drag").bind(window, "touchend", () => {
                            X.removeClass(p.__selector, "drag")
                        })
                    })
        ...
        ie = (() => {
            function e() {
                ...
                X.bind(this.backgroundElement, "click", () => {
                    this.hide()
                })
            }
            return (
                        ...
                        value: function () {
                            ;(this.domElement.style.left =
                                ...
                                (this.domElement.style.top =
                                    window.innerHeight / 2 - X.getHeight(this.domElement) / 2 + "px")
                        },
                    },
                ]),
                e
    ...
    var se = "Default",
        ...
        he = function e(t) {
            ...
            ;(this.domElement = document.createElement("div")),
                ...
                S.isUndefined(o.load) ? (o.load = { preset: se }) : o.preset && (o.load.preset = o.preset),
            ...
            if (
                (Object.defineProperties(this, {
                    ...
                    preset: {
                        get: () => (n.parent ? n.getRoot().preset : o.load.preset),
                        set: function (e) {
                ...
                ;(this.__closeButton = document.createElement("div")),
                    ...
                    X.bind(this.__closeButton, "click", () => {
                        n.closed = !n.closed
                    })
            } else {
                ...
                X.addClass(this.__ul, e.CLASS_CLOSED),
                    X.addClass(l, "title"),
                    X.bind(l, "click", (e) => (e.preventDefault(), (n.closed = !n.closed), !1)),
    ...
    ;(he.toggleHide = () => {
        ...
        S.extend(he.prototype, {
                ...
                if (e.scrollable) {
                    ...
                    S.each(e.__ul.childNodes, (t) => {
                        ...
                        window.innerHeight - t - 20 < n
                            ...
                            : (X.removeClass(e.domElement, he.CLASS_TOO_TALL), (e.__ul.style.height = "auto"))
                }
                e.__resize_handle &&
                    S.defer(() => {
            ...
            remember: function () {
                ...
                S.each(Array.prototype.slice.call(arguments), (t) => {
                    0 === this.__rememberedObjects.length && v(this),
                        -1 === this.__rememberedObjects.indexOf(t) && this.__rememberedObjects.push(t)
                }),
