...
!((e, t) => {
    ...
    var A = Array.prototype.forEach,
        ...
        S = {
            ...
            compose: () => {
                ...
                return function () {
                    for (
                        var t = k.call(arguments), n = e.length - 1;
                        n >= 0;
                        n--
                    )
                        t = [e[n].apply(this, t)]
    ...
    ;(I.recalculateRGB = (e, t, n) => {
        if ("HEX" === e.__state.space)
            ...
            S.extend(
                e.__state,
                N.hsv_to_rgb(e.__state.h, e.__state.s, e.__state.v),
            )
        }
    }),
        (I.recalculateHSV = (e) => {
                ...
                if (t)
                    if (e.className === t) e.removeAttribute("class")
                        ...
                        var n = e.className.split(/ +/),
                            o = n.indexOf(t)
                        ;-1 !== o &&
                            (n.splice(o, 1), (e.className = n.join(" ")))
                    }
                        ...
                        ? 0 === i.initialValue
                            ...
                            : (i.__impliedStep =
                                  Math.pow(
                                      10,
                                      Math.floor(
                                          Math.log(Math.abs(i.initialValue)) /
                                              Math.LN10,
                                      ),
                                  ) / 10)
        ...
        q = ((e) => {
            function t(e, n, o, i, r) {
                function s(e) {
                    ...
                    return (
                        _.setValue(
                            a(e.clientX, t.left, t.right, _.__min, _.__max),
                        ),
                        !1
                    )
                }
            ...
            function t(e, n) {
                ...
                function _(e) {
                    ...
                    var t = p.__hue_field.getBoundingClientRect(),
                        n =
                            1 -
                            (((e.touches && e.touches[0]) || e).clientY -
                                t.top) /
                                (t.bottom - t.top)
                    return (
                        n > 1 ? (n = 1) : n < 0 && (n = 0),
                ...
                return (
                    ...
                    S.extend(h.__field_knob.style, {
                        ...
                        height: "12px",
                        border:
                            h.__field_knob_border +
                            (h.__color.v < 0.5 ? "#fff" : "#000"),
                            ...
                            var e = this,
                                t = function t() {
                                    ;(e.domElement.style.display = "none"),
                                        (e.backgroundElement.style.display =
                                            "none"),
                                        X.unbind(
                                            e.domElement,
                                            "webkitTransitionEnd",
        ...
        he = function e(t) {
            ...
            if (
                (Object.defineProperties(this, {
                    ...
                    preset: {
                        get: () =>
                            n.parent ? n.getRoot().preset : o.load.preset,
                        set: function (e) {
                            n.parent
                                ? (n.getRoot().preset = e)
                                : (o.load.preset = e),
                ...
                X.addClass(this.__ul, e.CLASS_CLOSED),
                    ...
                    X.bind(
                        l,
                        "click",
                        (e) => (e.preventDefault(), (n.closed = !n.closed), !1),
                    ),
            ...
            remember: function () {
                ...
                S.each(Array.prototype.slice.call(arguments), (t) => {
                    0 === this.__rememberedObjects.length && v(this),
                        -1 === this.__rememberedObjects.indexOf(t) &&
                            this.__rememberedObjects.push(t)
                }),
