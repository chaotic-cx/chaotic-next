...
export const environment: EnvironmentModel = {
  ...
  cachedMetricsUrl: 'http://localhost:8011/proxy/metrics',
  deployLogId: '-1001402311166',
  ...
  pkgListUrl: 'https://builds.garudalinux.org/repos/chaotic-aur/pkgs.files.txt',
  ...
  tgApiUrl: 'http://localhost:8011/proxy/telegram',
};
