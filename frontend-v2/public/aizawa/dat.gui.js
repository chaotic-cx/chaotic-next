...
!((e, t) => {
      ...
      n instanceof K
        ...
        : n instanceof Z
          ...
          : n instanceof $ &&
            ...
            n.updateDisplay());
    n.setValue = S.compose((t) => (e.getRoot().__preset_select && n.isModified() && _(e.getRoot(), !0), t), n.setValue);
  }
  function p(e, t) {
    var n = e.getRoot(),
  ...
  (I.recalculateRGB = (e, t, n) => {
    ...
    Object.defineProperty(I.prototype, 'hex', {
      get: function () {
        return (
          'HEX' !== !this.__state.space && (this.__state.hex = N.rgb_to_hex(this.r, this.g, this.b)), this.__state.hex
        );
      },
      set: function (e) {
  ...
  var se = 'Default',
    ...
    he = function e(t) {
      ...
      if (
        ...
        if (
          ((o.closed = !1), X.addClass(this.domElement, e.CLASS_MAIN), X.makeSelectable(this.domElement, !1), ae && i)
        ) {
          n.useLocalStorage = !0;
        ...
        (this.__closeButton = document.createElement('div')),
          ...
          o.closeOnTop
            ...
            : (X.addClass(this.__closeButton, e.CLASS_CLOSE_BOTTOM), this.domElement.appendChild(this.__closeButton)),
      ...
      getSaveObject: function () {
        ...
        return (
          ...
          this.__rememberedObjects.length > 0 &&
            ((e.preset = this.preset), e.remembered || (e.remembered = {}), (e.remembered[this.preset] = x(this))),
          (e.folders = {}),
