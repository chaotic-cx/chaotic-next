...
const points = [];
const NUM_POINTS = 3900; //num of points in curve

const numMax = 600; //num of particles moving around
const t = 0;
const h = 0.01;
...
function rungeKutta(time, x, y, z, h) {
  const k1 = componentFX(time, x, y, z);
...
class Particle {
  ...
  update() {
    const tmp = rungeKutta(this.time, this.x, this.y, this.z, this.h);
